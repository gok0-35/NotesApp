class CustomNoteCard extends HTMLElement {
    connectedCallback() {
        ...
        const noteId = this.getAttribute('note-id'); // id attribute'u al
    ...
    <div class="card bg-white overflow-hidden shadow rounded-lg h-full">
        ...
        <div class="bg-gray-50 px-5 py-3 flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                <a href="/Note/Details/${noteId}" class="text-indigo-600 hover:text-indigo-900">
                    <i data-feather="eye"></i>
                </a>
                <a href="/Note/Edit/${noteId}" class="text-indigo-600 hover:text-indigo-900">
